...
from agent_8_multi_agent_langchain.research_agents.geo_performance_agent.firebase_client import *
import os
...
def get_data(state: BudgetOptState):
    print("⚡ inside get_data BEFORE import")
...
def create_budget_optimization_graph(checkpointer=None) -> Graph:
    print("▶️ create_budget_optimization_graph()")
...
if __name__ == "__main__":
    graph = create_budget_optimization_graph()
    thread_config = {"configurable": {"thread_id": "some_id"}}
